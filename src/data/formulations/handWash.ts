...
export const handWashFormulation: FormulationData = {
  ...
  ingredients: [
    { slNo: 1, particulars: "Handwash Base - Pearl", uom: "LTR", qty: 1.0, rate: 200, amount: 1.0 * 200 },
    { slNo: 2, particulars: "SLES", uom: "KGS", qty: 1.0, rate: 100, amount: 1.0 * 100 },
    { slNo: 3, particulars: "Sodium Sulphate", uom: "KGS", qty: 1.0, rate: 40, amount: 1.0 * 40 },
    ...
    { slNo: 7, particulars: "RO Water", uom: "LTR", qty: 10.0, rate: 0.5, amount: 10.0 * 0.5 }
  ],
